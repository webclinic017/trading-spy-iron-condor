...
def _build_lessons_page(lessons: list[dict]) -> str:
    ...
    schema = {
        ...
        "name": "Trading System Lessons Learned",
    ...
    content = [
        ...
        'description: "Structured index of lessons learned from the trading system."',
        "---",
        "",
        "<h1>Lessons Learned Index</h1>",
        "<p>A structured, crawlable index of trading lessons and operational findings.</p>",
