...
- Max Drawdown (sync history): 1.78% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1450 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,381.12 (-1.38%) [WARN]
- Monthly run-rate estimate: $-41,433.60/month [WARN]
