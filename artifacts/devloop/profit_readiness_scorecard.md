...
- Max Drawdown (sync history): 0.30% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1631 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-251.66 (-0.25%) [WARN]
- Monthly run-rate estimate: $-7,549.80/month [WARN]
