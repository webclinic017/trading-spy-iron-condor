...
- Max Drawdown (sync history): 1.31% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1119 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,304.30 (-1.31%) [WARN]
- Monthly run-rate estimate: $-39,129.00/month [WARN]
