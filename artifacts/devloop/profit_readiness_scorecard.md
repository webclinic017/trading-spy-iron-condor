...
- Max Drawdown (sync history): 0.28% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 984 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-283.39 (-0.28%) [WARN]
- Monthly run-rate estimate: $-8,501.70/month [WARN]
