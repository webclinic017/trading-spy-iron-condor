...
- Max Drawdown (sync history): 1.42% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 829 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,414.30 (-1.42%) [WARN]
- Monthly run-rate estimate: $-42,429.00/month [WARN]
