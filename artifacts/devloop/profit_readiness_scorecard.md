...
- Max Drawdown (sync history): 1.02% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1046 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-829.43 (-0.83%) [WARN]
- Monthly run-rate estimate: $-24,882.90/month [WARN]
