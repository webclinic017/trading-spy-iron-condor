...
- Max Drawdown (sync history): 0.07% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1251 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-59.24 (-0.06%) [WARN]
- Monthly run-rate estimate: $-1,777.20/month [WARN]
