...
- Max Drawdown (sync history): 1.25% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1224 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,211.74 (-1.22%) [WARN]
- Monthly run-rate estimate: $-36,352.20/month [WARN]
