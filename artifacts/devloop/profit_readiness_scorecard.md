...
- Max Drawdown (sync history): 1.58% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1884 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,178.14 (-1.18%) [WARN]
- Monthly run-rate estimate: $-35,344.20/month [WARN]
