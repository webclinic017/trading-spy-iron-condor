...
- Max Drawdown (sync history): 0.15% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1116 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-147.20 (-0.15%) [WARN]
- Monthly run-rate estimate: $-4,416.00/month [WARN]
