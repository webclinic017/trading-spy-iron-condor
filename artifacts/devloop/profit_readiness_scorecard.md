...
- Max Drawdown (sync history): 1.12% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1151 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,009.43 (-1.01%) [WARN]
- Monthly run-rate estimate: $-30,282.90/month [WARN]
