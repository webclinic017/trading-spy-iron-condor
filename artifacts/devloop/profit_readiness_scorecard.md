...
- Max Drawdown (sync history): 1.26% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 892 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,056.02 (-1.07%) [WARN]
- Monthly run-rate estimate: $-31,680.60/month [WARN]
