...
- Max Drawdown (sync history): 0.12% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1581 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (2d): $-121.23 (-0.12%) [WARN]
- Monthly run-rate estimate: $-1,818.45/month [WARN]
