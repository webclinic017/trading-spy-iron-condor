...
- Max Drawdown (sync history): 0.33% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 801 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-329.56 (-0.33%) [WARN]
- Monthly run-rate estimate: $-9,886.80/month [WARN]
