...
- Max Drawdown (sync history): 1.23% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 798 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,085.47 (-1.09%) [WARN]
- Monthly run-rate estimate: $-32,564.10/month [WARN]
