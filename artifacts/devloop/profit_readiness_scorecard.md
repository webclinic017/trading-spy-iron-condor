...
- Max Drawdown (sync history): 0.36% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1508 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-337.11 (-0.33%) [WARN]
- Monthly run-rate estimate: $-10,113.30/month [WARN]
