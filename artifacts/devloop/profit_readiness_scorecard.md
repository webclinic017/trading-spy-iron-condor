...
- Max Drawdown (sync history): 0.13% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1273 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-133.65 (-0.13%) [WARN]
- Monthly run-rate estimate: $-4,009.50/month [WARN]
