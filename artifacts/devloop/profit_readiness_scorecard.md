...
- Max Drawdown (sync history): 0.11% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1146 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-109.49 (-0.11%) [WARN]
- Monthly run-rate estimate: $-3,284.70/month [WARN]
