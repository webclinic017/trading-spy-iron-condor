...
- Max Drawdown (sync history): 0.14% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 2114 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (2d): $-103.31 (-0.10%) [WARN]
- Monthly run-rate estimate: $-1,549.65/month [WARN]
