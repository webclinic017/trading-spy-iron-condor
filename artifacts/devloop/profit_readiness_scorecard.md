...
- Max Drawdown (sync history): 1.04% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1085 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,009.74 (-1.02%) [WARN]
- Monthly run-rate estimate: $-30,292.20/month [WARN]
