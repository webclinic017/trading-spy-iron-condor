...
- Max Drawdown (sync history): 0.20% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1122 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-180.40 (-0.18%) [WARN]
- Monthly run-rate estimate: $-5,412.00/month [WARN]
