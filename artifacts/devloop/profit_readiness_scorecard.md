...
- Max Drawdown (sync history): 0.22% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1102 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (2d): $-205.63 (-0.21%) [WARN]
- Monthly run-rate estimate: $-3,084.45/month [WARN]
