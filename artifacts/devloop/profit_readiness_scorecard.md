...
- Max Drawdown (sync history): 0.19% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1017 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (2d): $-161.59 (-0.16%) [WARN]
- Monthly run-rate estimate: $-2,423.85/month [WARN]
