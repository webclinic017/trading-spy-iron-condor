...
- Max Drawdown (sync history): 0.90% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 916 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-781.23 (-0.78%) [WARN]
- Monthly run-rate estimate: $-23,436.90/month [WARN]
