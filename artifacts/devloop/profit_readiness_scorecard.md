...
- Max Drawdown (sync history): 0.88% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 746 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-755.23 (-0.76%) [WARN]
- Monthly run-rate estimate: $-22,656.90/month [WARN]
