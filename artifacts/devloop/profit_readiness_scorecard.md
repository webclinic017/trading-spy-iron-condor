...
- Max Drawdown (sync history): 0.45% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1383 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-432.32 (-0.44%) [WARN]
- Monthly run-rate estimate: $-12,969.60/month [WARN]
