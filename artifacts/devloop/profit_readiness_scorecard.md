...
- Max Drawdown (sync history): 0.06% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1297 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-50.68 (-0.05%) [WARN]
- Monthly run-rate estimate: $-1,520.40/month [WARN]
