...
- Max Drawdown (sync history): 1.00% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1338 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-791.74 (-0.80%) [WARN]
- Monthly run-rate estimate: $-23,752.20/month [WARN]
