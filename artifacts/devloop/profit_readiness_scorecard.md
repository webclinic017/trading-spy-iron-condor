...
- Max Drawdown (sync history): 1.45% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 792 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,301.47 (-1.30%) [WARN]
- Monthly run-rate estimate: $-39,044.10/month [WARN]
