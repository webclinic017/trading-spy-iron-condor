...
- Max Drawdown (sync history): 0.38% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1828 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-379.23 (-0.38%) [WARN]
- Monthly run-rate estimate: $-11,376.90/month [WARN]
