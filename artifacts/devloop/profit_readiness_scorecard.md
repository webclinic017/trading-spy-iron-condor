...
- Max Drawdown (sync history): 0.37% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1257 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-353.06 (-0.35%) [WARN]
- Monthly run-rate estimate: $-10,591.80/month [WARN]
