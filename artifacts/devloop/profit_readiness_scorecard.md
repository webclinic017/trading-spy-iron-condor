...
- Max Drawdown (sync history): 0.05% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1752 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (2d): $-25.51 (-0.03%) [WARN]
- Monthly run-rate estimate: $-382.65/month [WARN]
