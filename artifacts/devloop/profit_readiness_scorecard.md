...
- Max Drawdown (sync history): 0.25% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1172 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-251.42 (-0.25%) [WARN]
- Monthly run-rate estimate: $-7,542.60/month [WARN]
