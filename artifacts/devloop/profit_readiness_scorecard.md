...
- Max Drawdown (sync history): 1.13% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1215 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,017.71 (-1.02%) [WARN]
- Monthly run-rate estimate: $-30,531.30/month [WARN]
