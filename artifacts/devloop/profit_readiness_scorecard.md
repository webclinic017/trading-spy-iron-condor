...
- Max Drawdown (sync history): 1.16% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 924 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,119.74 (-1.13%) [WARN]
- Monthly run-rate estimate: $-33,592.20/month [WARN]
