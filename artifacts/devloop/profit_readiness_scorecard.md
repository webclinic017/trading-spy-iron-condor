...
- Max Drawdown (sync history): 0.27% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1724 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-269.61 (-0.27%) [WARN]
- Monthly run-rate estimate: $-8,088.30/month [WARN]
