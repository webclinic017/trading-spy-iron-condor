...
- Max Drawdown (sync history): 1.15% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1029 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,065.74 (-1.08%) [WARN]
- Monthly run-rate estimate: $-31,972.20/month [WARN]
