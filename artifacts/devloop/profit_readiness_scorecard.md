...
- Max Drawdown (sync history): 0.35% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1241 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-335.19 (-0.33%) [WARN]
- Monthly run-rate estimate: $-10,055.70/month [WARN]
