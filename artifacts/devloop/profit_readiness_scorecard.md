...
- Max Drawdown (sync history): 1.53% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1076 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,523.39 (-1.52%) [WARN]
- Monthly run-rate estimate: $-45,701.70/month [WARN]
