...
- Max Drawdown (sync history): 0.67% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1593 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-575.47 (-0.58%) [WARN]
- Monthly run-rate estimate: $-17,264.10/month [WARN]
