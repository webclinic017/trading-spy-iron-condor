...
- Max Drawdown (sync history): 1.44% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1195 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,340.02 (-1.35%) [WARN]
- Monthly run-rate estimate: $-40,200.60/month [WARN]
