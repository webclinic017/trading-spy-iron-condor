...
- Max Drawdown (sync history): 0.09% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1035 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-89.09 (-0.09%) [WARN]
- Monthly run-rate estimate: $-2,672.70/month [WARN]
