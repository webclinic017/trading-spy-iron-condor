...
- Max Drawdown (sync history): 0.79% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 862 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-766.48 (-0.78%) [WARN]
- Monthly run-rate estimate: $-22,994.40/month [WARN]
