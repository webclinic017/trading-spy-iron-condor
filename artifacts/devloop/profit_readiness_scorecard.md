...
- Max Drawdown (sync history): 1.71% [PASS] (equity_points=24)
- Execution Quality (valid trade records): 97.89% [PASS] (valid=93/95)
- Gateway Latency: 1549 ms [PASS] (from artifacts/tars/smoke_metrics.txt)
...
## 7-Day Delta
- Equity delta (1d): $-1,316.38 (-1.32%) [WARN]
- Monthly run-rate estimate: $-39,491.40/month [WARN]
