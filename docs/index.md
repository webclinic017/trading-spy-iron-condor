...
<!-- AUTO_STATUS_START -->
_Last Sync: 2026-02-18 14:40 UTC (source: `data/system_state.json`)_
...
Captured: `2026-02-18T14:02:57Z`

Technical readout: Paper Account: net liquidation value $101,401.96; daily P/L -35.60 (-3.5 bps) indicating a negative drift session; cumulative P/L +1,401.96 (+1.40%); low capital deployment at 0.0% utilization with cash $101,401.96; open position proxy 0; win-rate estimate 100.0% (n=1); North Star gate MEDIUM.
...
Technical readout: Brokerage Account: net liquidation value $208.55; daily P/L +0.00 (+0.0 bps) indicating a flat premium-decay session; cumulative P/L +188.55 (+942.75%); high capital deployment at 90.4% utilization with cash $40.00; open position proxy 0; win-rate estimate 0.0% (n=0); North Star gate MEDIUM.
