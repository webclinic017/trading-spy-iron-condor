...
<!-- AUTO_STATUS_START -->
_Last Sync: 2026-02-19 17:18 UTC (source: `data/system_state.json`)_

| What | Status |
| ---- | ------ |
| Account Equity | $101,354.56 |
| Daily P/L | -$60.28 |
...
Captured: `2026-02-19T15:14:56Z`

Technical readout: Paper Account: net liquidation value $101,349.60; daily P/L -65.24 (-6.4 bps) indicating a negative drift session; cumulative P/L +1,349.60 (+1.35%); low capital deployment at 2.6% utilization with cash $101,246.60; open position proxy 7; win-rate estimate 100.0% (n=1); North Star gate MEDIUM.
...
Technical readout: Brokerage Account: net liquidation value $208.17; daily P/L +0.00 (+0.0 bps) indicating a flat premium-decay session; cumulative P/L +188.17 (+940.85%); high capital deployment at 90.4% utilization with cash $40.00; open position proxy 0; win-rate estimate 0.0% (n=0); North Star gate MEDIUM.
