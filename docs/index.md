...
<!-- AUTO_STATUS_START -->
_Last Sync: 2026-02-23 20:10 UTC (source: `data/system_state.json`)_

| What | Status |
| ---- | ------ |
| Account Equity | $101,165.33 |
| Daily P/L | -$91.16 |
| Win Rate | 100.0% (1 trades; target 80.0%) |
| Paper Phase | Day 14/90 |
| North Star Gate | ACTIVE (VALIDATING) |
| Open Positions | 1 structure(s), 1 option leg(s) |
| Unrealized P/L | +$32.00 |
...
Captured: `2026-02-23T20:02:13Z`

Technical readout: Paper Account: net liquidation value $101,131.33; daily P/L -125.16 (-12.4 bps) indicating a negative drift session; cumulative P/L +1,131.33 (+1.13%); low capital deployment at 0.9% utilization with cash $100,175.33; open position proxy 1; win-rate estimate 100.0% (n=1); North Star gate LOW.
...
Technical readout: Brokerage Account: net liquidation value $207.43; daily P/L +0.00 (+0.0 bps) indicating a flat premium-decay session; cumulative P/L +187.43 (+937.15%); high capital deployment at 99.0% utilization with cash $4.00; open position proxy 0; win-rate estimate 0.0% (n=0); North Star gate LOW.
