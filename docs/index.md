...
<!-- AUTO_STATUS_START -->
_Last Sync: 2026-02-17 18:15 UTC (source: `data/system_state.json`)_

| What | Status |
| ---- | ------ |
| Account Equity | $101,501.24 |
| Daily P/L | +$0.00 |
| Win Rate | 100.0% (1 trades; target 80.0%) |
| Paper Phase | Day 14/90 |
| North Star Gate | ACTIVE (VALIDATING) |
| Open Positions | 1 structure(s), 6 option leg(s) |
| Unrealized P/L | -$14.00 |
...
Captured: `2026-02-17T18:03:46Z`

Technical readout: Paper Account: net liquidation value $101,498.24; daily P/L +0.00 (+0.0 bps) indicating a flat premium-decay session; cumulative P/L +1,498.24 (+1.50%); low capital deployment at 1.4% utilization with cash $102,036.24; open position proxy 6; win-rate estimate 100.0% (n=1); North Star gate MEDIUM.
...
Technical readout: Brokerage Account: net liquidation value $207.19; daily P/L +0.00 (+0.0 bps) indicating a flat premium-decay session; cumulative P/L +187.19 (+935.95%); high capital deployment at 90.3% utilization with cash $40.00; open position proxy 0; win-rate estimate 0.0% (n=0); North Star gate MEDIUM.
