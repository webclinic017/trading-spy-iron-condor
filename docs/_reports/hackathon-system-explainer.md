...
Last Updated (UTC): 2026-02-16T17:03:40Z
...
- Generated (UTC): `2026-02-16T17:03:40Z`
- Open Layer-1 tasks: `2`

## Active Tasks (with elapsed time)
- `ACTIVE` Add expectancy metrics (profit factor, avg winner, avg loser) to `scripts/generate_profit_readiness_scorecard.py`. (elapsed: 2h 44m)
- `ACTIVE` Add a promotion gate artifact that blocks strategy promotion when win rate/run-rate thresholds are below target. (elapsed: 2h 44m)
...
## Runtime Phases
- Last analyze: cycle=41 profile=profit duration=38s
...
- Generated (UTC): `2026-02-16T17:02:44Z`
- Auto-restart: `1`
- Stale threshold: `900s`

| Loop | PID | Cycle | Profile | Last Update (UTC) | Age | Open Tasks | STOP | State | Action |
|---|---:|---:|---|---|---:|---:|---|---|---|
| main | 99350 | n/a | n/a | n/a | 199s | 2 | no | OK | - |
| strategy | 99354 | n/a | n/a | n/a | 18s | 3 | no | OK | - |
| tetrate | 11469 | n/a | n/a | n/a | 310s | 3 | no | OK | - |
| evidence | 11516 | n/a | n/a | n/a | 279s | 3 | no | OK | - |
