...
Last Updated (UTC): 2026-02-16T15:01:55Z
...
- Generated (UTC): `2026-02-16T15:00:27Z`
- Open Layer-1 tasks: `2`

## Active Tasks (with elapsed time)
- `ACTIVE` Add expectancy metrics (profit factor, avg winner, avg loser) to `scripts/generate_profit_readiness_scorecard.py`. (elapsed: 41m 12s)
- `ACTIVE` Add a promotion gate artifact that blocks strategy promotion when win rate/run-rate thresholds are below target. (elapsed: 41m 12s)
...
## Runtime Phases
- Last analyze: cycle=5 profile=profit duration=22s
...
- Generated (UTC): `2026-02-16T15:01:06Z`
- Auto-restart: `1`
- Stale threshold: `900s`

| Loop | PID | Cycle | Profile | Last Update (UTC) | Age | Open Tasks | STOP | State | Action |
|---|---:|---:|---|---|---:|---:|---|---|---|
| main | 47156 | n/a | n/a | n/a | 39s | 2 | no | OK | - |
| strategy | 61129 | n/a | n/a | n/a | 423s | 4 | no | OK | - |
| tetrate | 61138 | n/a | n/a | n/a | 273s | 4 | no | OK | - |
| evidence | 61164 | n/a | n/a | n/a | 273s | 4 | no | OK | - |
