...
Last Updated (UTC): 2026-02-16T16:47:23Z
...
- Generated (UTC): `2026-02-16T16:47:21Z`
- Open Layer-1 tasks: `2`

## Active Tasks (with elapsed time)
- `ACTIVE` Add expectancy metrics (profit factor, avg winner, avg loser) to `scripts/generate_profit_readiness_scorecard.py`. (elapsed: 2h 28m)
- `ACTIVE` Add a promotion gate artifact that blocks strategy promotion when win rate/run-rate thresholds are below target. (elapsed: 2h 28m)
...
## Runtime Phases
- Last analyze: cycle=33 profile=profit duration=33s
- Last TARS: cycle=33 duration=1m 33s
- Last RAG: cycle=30 duration=24s
...
- Generated (UTC): `2026-02-16T16:46:33Z`
- Auto-restart: `1`
- Stale threshold: `900s`

| Loop | PID | Cycle | Profile | Last Update (UTC) | Age | Open Tasks | STOP | State | Action |
|---|---:|---:|---|---|---:|---:|---|---|---|
| main | 99350 | n/a | n/a | n/a | 45s | 2 | no | OK | - |
| strategy | 99354 | n/a | n/a | n/a | 235s | 3 | no | OK | - |
| tetrate | 11469 | n/a | n/a | n/a | 196s | 3 | no | OK | - |
| evidence | 11516 | n/a | n/a | n/a | 154s | 3 | no | OK | - |
