...
Last Updated (UTC): 2026-02-16T15:06:58Z

## Current Runtime Snapshot
- Latest cycle: `n/a`
- Latest profile: `n/a`
- Latest loop status timestamp: `n/a`
- Latest Tetrate latency: `1196 ms`
...
- Generated (UTC): `2026-02-16T15:04:29Z`
- Open Layer-1 tasks: `2`

## Active Tasks (with elapsed time)
- `ACTIVE` Add expectancy metrics (profit factor, avg winner, avg loser) to `scripts/generate_profit_readiness_scorecard.py`. (elapsed: 45m 14s)
- `ACTIVE` Add a promotion gate artifact that blocks strategy promotion when win rate/run-rate thresholds are below target. (elapsed: 45m 14s)
...
## Runtime Phases
- Last analyze: cycle=2 profile=profit duration=23s
- Last TARS: cycle=3 duration=1m 46s
...
- Generated (UTC): `2026-02-16T15:06:36Z`
- Auto-restart: `1`
- Stale threshold: `900s`

| Loop | PID | Cycle | Profile | Last Update (UTC) | Age | Open Tasks | STOP | State | Action |
|---|---:|---:|---|---|---:|---:|---|---|---|
| main | 66918 | n/a | n/a | n/a | 109s | 2 | no | OK | - |
| strategy | 71466 | n/a | n/a | n/a | 292s | 4 | yes | PAUSED | - |
| tetrate | 72890 | n/a | n/a | n/a | 292s | 4 | yes | PAUSED | - |
| evidence | 61164 | n/a | n/a | n/a | 292s | 4 | yes | PAUSED | - |
